...
# En lugar de usar input, obtén la consulta de los argumentos de línea de comandos
if len(sys.argv) > 1:
...
# 10 de Google y 10 de DuckDuckGo
...
# La tokenización implica dividir el texto en palabras o términos individuales, lo que facilita el cálculo de TF-IDF. El tokenizador está integrado en la biblioteca TfidfVectorizer de scikit-learn
...
# docker build -t practi-image .
# docker run practi-image
# docker run -it f86d7e75268c48644fd02db1dadabb6966f8186de87c4318c3a2e04bcaae8562